...
public class DuplexBlockingPingPongServer {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	BlockingService pingService = PingService.newReflectiveBlockingService(new PingServiceImpl());
     ...
     */
	static class PingServiceImpl implements PingService.BlockingInterface {

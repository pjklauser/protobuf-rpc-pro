...
public interface RpcTimeoutChecker extends ExecutorService {
	 ...
	 * 
	 * @param rpcClientRegistry
	 */
	public void startChecking( RpcClientRegistry rpcClientRegistry );
	
	
	/**
	 * Stop all RPC timeout monitoring of the RPC calls for the clients of the Registry.
	 * 
	 * @param rpcClientRegistry
	 */
	 ...
	 * @param executor
	 */
	public void setTimeoutExecutor( RpcTimeoutExecutor executor );
